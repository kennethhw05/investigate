...
// GetTournamentSummary Get a LoL tournament summary from sportradar given a tournament id
// from their system
...
// GetLiveTournamentSummary Get LoL live tournament summary from sportradar
...
// GetTeamProfile Get a LoL team profile from sportradar given a team id
// from their system
...
// GetTournaments Get a list of LoL tournaments from sportradar
...
// GetTournamentInfo Get LoL tournament info from sportradar given an ID from
// their system
...
// GetPlayerProfile Get a LoL player profile from sportradar given an ID
// from their system
...
// GetMatchSummary Get a LoL match summary from sportradar given an ID from
// their system
...
// GetMatchProbabilities Get match probabilities from a LoL sportradar match
...
// GetMatchLineups Get LoL match lineups from sportradar given an ID from
// their system
